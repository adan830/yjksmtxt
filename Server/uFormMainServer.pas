...
procedure TFormMainServer.mnbtnAddFirewallItemClick(Sender : TObject);
   ...
   begin
      try
         ...
         if r>31 then
            Application.MessageBox('成功添加防火墙例外！','提示')
         else
            Application.MessageBox('添加防火墙例外失败！','提示') ;
      end;
...
procedure TFormMainServer.SaveConfig;
   ...
   begin
      ...
      TExamServerGlobal.GlobalStkRecordInfo.BaseConfig.ModifyCustomConfig(TExamServerGlobal.ServerCustomConfig.StatusRefreshInterval,
         TExamServerGlobal.ServerCustomConfig.LoginPermissionModel); // TExamServerGlobal.ServerCustomConfig.ExamPath,
      ServerStatus := essReady;
   end;
