...
interface
   ...
   type
      TCustomQuestionLoginForm = class(TForm)
...
implementation
   ...
   const
      xTitleHeight: Integer  = 75; // 标题栏的高度
      xFramWidth: Integer    = 0;   // 左、右、下边框的厚度
      xHitTestWidth: Integer = 5;   // HitTest预留厚度

   procedure TCustomQuestionLoginForm.WMNCCALCSIZE(var Message: TWMNCCALCSIZE);
      begin
   ...
   procedure TCustomQuestionLoginForm.DrawTitle;
      var
         TitleBmp: TBitmap;
         DC      : HDC;
         C       : TCanvas;
   ...
   procedure TCustomQuestionLoginForm.WMNCPaint(var Message: TWMNCPaint);
      begin
         DrawTitle;
         Message.Result := 1;
      end;

   procedure TCustomQuestionLoginForm.WMNCActivate(var Message: TWMNCActivate);
      begin
   ...
   procedure TCustomQuestionLoginForm.WMPaint(var Message: TWMPaint);
      var
         DC: HDC;
         PS: TPaintStruct;
      begin
   ...
   procedure TCustomQuestionLoginForm.WMEraseBkgnd(var Message: TWMEraseBkgnd);
      var
         DC: HDC;
      begin
         DC := Message.DC;
   ...
   procedure TCustomQuestionLoginForm.WMActivate(var Message: TWMActivate);
      begin
         inherited;
//         if mess then
   ...
   procedure TCustomQuestionLoginForm.WMNCHitTest(var Message: TWMNCHITTEST);
      var
         P: TPoint;
         r: TRect;
      begin
   ...
   procedure TCustomQuestionLoginForm.WMNCLBUTTONDBLCLK(var Message: TWMNCLButtonDblClk);
      var
         P    : TPoint;
         Style: DWORD;
      begin
   ...
   procedure TCustomQuestionLoginForm.WMSize(var Message: TWMSize);
      var
         Rgn: HRGN;
      begin
         inherited;
   ...
   destructor TCustomQuestionLoginForm.Destroy;
      begin
         m_BackBMP.Free;
   ...
   procedure TCustomQuestionLoginForm.DrawClient(DC: HDC);
      var
         C: TCanvas;
      begin
         C        := TControlCanvas.Create;
   ...
   procedure TCustomQuestionLoginForm.DrawShadow(canvas: TCanvas; rect: TRect; direction: Integer);
      var
         i: Integer;
      begin
         with canvas do
   ...
   procedure TCustomQuestionLoginForm.WMGETMINMAXINFO(var Message: TMessage);
      var
         rect: TRect;
      begin
   ...
   procedure TCustomQuestionLoginForm.OnButtonUp(P: TPoint);
      var
         Style: DWORD;
      begin
   ...
   procedure TCustomQuestionLoginForm.WMLBUTTONUP(var Message: TWMLButtonUp);
      var
         P: TPoint;
      begin
         inherited;
   ...
   procedure TCustomQuestionLoginForm.WMNCLButtonDown(var Message: TWMNCLButtonDown);
      begin
   ...
   procedure TCustomQuestionLoginForm.WMNCLButtonUp(var Message: TWMNCLButtonUp);
      var
         P: TPoint;
      begin
   ...
   procedure TCustomQuestionLoginForm.WMNCMouseMove(var Message: TWMNCMousemove);
      var
         P: TPoint;
         r: TRect;
      begin
   ...
   procedure TCustomQuestionLoginForm.Timer1Timer(Sender: TObject);
      var
         P: TPoint;
         r: TRect;
      begin
   ...
   function TCustomQuestionLoginForm.GetRectCloseButton: TRect;
      begin
         Result := rect(Width - btn_close_normal.Width, 0, Width, btn_close_normal.Height);
      end;

   function TCustomQuestionLoginForm.GetRectMaxButton: TRect;
      begin
   ...
   function TCustomQuestionLoginForm.GetRectMiniButton: TRect;
      begin
         if biMaximize in BorderIcons then
   ...
   procedure TCustomQuestionLoginForm.GaussianBlur(Bmp: TBitmap; Amount: Integer);
      var
         i: Integer;
...
//            SplitBlur(i);
   ...
   // 模糊
   procedure TCustomQuestionLoginForm.Blur(SrcBmp: TBitmap);
      var
         i, j      : Integer;
         SrcRGB    : pRGBTriple;
   ...
   // RGB<=>BGR
   procedure TCustomQuestionLoginForm.RGB2BGR(const Bitmap: TBitmap);
      var
         X    : Integer;
         Y    : Integer;
         PRGB : pRGBTriple;
   ...
   procedure TCustomQuestionLoginForm.SetShadowed(const Value: Boolean);
      begin
   ...
   // 灰度化(加权)
   procedure TCustomQuestionLoginForm.Grayscale(const Bitmap: TBitmap);
      var
         X   : Integer;
         Y   : Integer;
         PRGB: pRGBTriple;
   ...
   procedure TCustomQuestionLoginForm.InitializeNewForm;
      begin
         inherited;
         m_BackBMP := TBitmap.Create;
         m_BackBMP.LoadFromResourceName(HInstance, 'Question_caption');
   ...
   // 反色
   procedure TCustomQuestionLoginForm.Negative(Bmp: TBitmap);
      var
         i, j: Integer;
         PRGB: pRGBTriple;
      begin
   ...
   procedure TCustomQuestionLoginForm.AlphaBlendDraw(destCanvas: TCanvas);
      var
   ...
   procedure TCustomQuestionLoginForm.DrawAlphaBlend(destHandle: hwnd; sourceDc: HDC);
      var
